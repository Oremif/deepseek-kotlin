 ...
 *
 * This class encapsulates configuration options used by both standard and streaming DeepSeek
 * clients, including serialization settings and request timeouts.
 *
 * @property jsonConfig JSON serialization configuration for API requests and responses
 * @property chatCompletionTimeout Timeout in milliseconds for chat completion requests; defaults to
 *   5 minutes, since a thinking model can spend minutes on a single non-streaming call
