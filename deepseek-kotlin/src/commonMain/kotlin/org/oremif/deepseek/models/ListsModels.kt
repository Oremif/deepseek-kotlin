...
/**
 * Response payload of [org.oremif.deepseek.api.models] — a list of DeepSeek models available to the
 * current API key.
 *
...
public class ListsModels(
    ...
    override fun toString(): String = "ListsModels(`object`='$`object`', data=$data)"
}
