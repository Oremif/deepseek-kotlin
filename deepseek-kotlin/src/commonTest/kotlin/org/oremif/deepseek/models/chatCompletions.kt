...
class ChatCompletionTests {
    ...
    fun `tool call arguments are decoded as a raw JSON string`() {
        ...
        call.function
            ...
            .shouldNotBeNull()["location"]
            ?.jsonPrimitive
            ?.content shouldBe "Tokyo"
    }
    ...
    fun `ChatModel serializes as its raw slug and accepts unknown ones`() {
        ...
        jsonConfig.decodeFromString<ChatModel>("\"deepseek-v5-flash\"") shouldBe
            ChatModel("deepseek-v5-flash")
    ...
    fun `a strict function declaration decodes as a request not a response`() {
        val json =
            """{"name": "get_weather", "description": null, "parameters": {}, "strict": true}"""
